...
import { AccountValidationService } from './core/jwt/account-validation.service';
import { JwtStrategy } from './core/jwt/jwt.strategy';
import { ValidationService } from './core/jwt/validation.service';
...
@Module({
  ...
  providers: [JwtStrategy, ValidationService, AccountValidationService],
  exports: [JwtStrategy, ValidationService, AccountValidationService],
})
